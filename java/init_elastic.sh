...
docker run --name=elk_loggers -d -p 9200:9200 -p 5601:5601 -v /opt/workspace/priv/wystapienia/loggers/elk_storage:/home/elasticsearch/elasticsearch/data  nshou/elasticsearch-kibana
